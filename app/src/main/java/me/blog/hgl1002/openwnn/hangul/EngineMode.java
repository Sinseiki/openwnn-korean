...
import static me.blog.hgl1002.openwnn.layout.Layout12KeyDubul.COMB_DUBUL_12KEY_CHEONJIIN;
import static me.blog.hgl1002.openwnn.layout.Layout12KeyDubul.COMB_DUBUL_12KEY_NARATGEUL;
import static me.blog.hgl1002.openwnn.layout.Layout12KeyDubul.COMB_DUBUL_12KEY_SKY2;
import static me.blog.hgl1002.openwnn.layout.Layout12KeyDubul.CYCLE_DUBUL_12KEY_CHEONJIIN;
import static me.blog.hgl1002.openwnn.layout.Layout12KeyDubul.CYCLE_DUBUL_12KEY_NARATGEUL;
import static me.blog.hgl1002.openwnn.layout.Layout12KeyDubul.CYCLE_DUBUL_12KEY_SKY2;
import static me.blog.hgl1002.openwnn.layout.Layout12KeyDubul.STROKE_DUBUL_12KEY_NARATGEUL;
import static me.blog.hgl1002.openwnn.layout.Layout12KeySebul.COMB_SEBUL_12KEY_HANSON;
import static me.blog.hgl1002.openwnn.layout.Layout12KeySebul.COMB_SEBUL_12KEY_MUNHWA;
import static me.blog.hgl1002.openwnn.layout.Layout12KeySebul.COMB_SEBUL_12KEY_SENA;
import static me.blog.hgl1002.openwnn.layout.Layout12KeySebul.CYCLE_SEBUL_12KEY_HANSON;
import static me.blog.hgl1002.openwnn.layout.Layout12KeySebul.CYCLE_SEBUL_12KEY_MUNHWA;
import static me.blog.hgl1002.openwnn.layout.Layout12KeySebul.CYCLE_SEBUL_12KEY_SENA;
...
import static me.blog.hgl1002.openwnn.layout.LayoutAlphabet.CYCLE_12KEY_ALPHABET_B;
import static me.blog.hgl1002.openwnn.layout.LayoutAlphabet.CYCLE_12KEY_ALPHABET_SMALLQWERTY;
import static me.blog.hgl1002.openwnn.layout.LayoutDev.COMB_NEBUL_1969;
...
import static me.blog.hgl1002.openwnn.layout.LayoutDubul.COMB_DUBUL_DUGYEOBE;
...
import static me.blog.hgl1002.openwnn.layout.LayoutGongSebul.COMB_SEBUL_DANMOEUM;
import static me.blog.hgl1002.openwnn.layout.LayoutGongSebul.COMB_SEBUL_SUN_2014;
import static me.blog.hgl1002.openwnn.layout.LayoutGongSebul.JAMO_SEBUL_390;
import static me.blog.hgl1002.openwnn.layout.LayoutGongSebul.JAMO_SEBUL_391;
import static me.blog.hgl1002.openwnn.layout.LayoutGongSebul.JAMO_SEBUL_393Y;
import static me.blog.hgl1002.openwnn.layout.LayoutGongSebul.JAMO_SEBUL_DANMOEUM;
import static me.blog.hgl1002.openwnn.layout.LayoutGongSebul.JAMO_SEBUL_SUN_2014;
...
import static me.blog.hgl1002.openwnn.layout.LayoutShinSebul.JAMOSET_SHIN_EDIT;
...
public enum EngineMode {
	...
	DUBULSIK_DUGYEOBE		(new Properties(), null, JAMOSET_DUBUL_DUGYEOBE, COMB_DUBUL_DUGYEOBE, null, "keyboard_dubul_dugyeobe"),
	DUBULSIK_DUJULE		(new Properties(), JAMO_DUBUL_DUJULE, null, COMB_DUBUL_STANDARD, null, "keyboard_dubul_dujule"),
	...
	TWELVE_ALPHABET_A			(new Properties(DefaultSoftKeyboard.LANG_EN, false, false, false, false, true, true),
			CYCLE_12KEY_ALPHABET_A, null, null, null, "keyboard_12key_alphabet_wide_a", "keyboard_12key_alphabet_narrow_a"),
	TWELVE_ALPHABET_B			(new Properties(DefaultSoftKeyboard.LANG_EN, false, false, false, false, true, true),
			CYCLE_12KEY_ALPHABET_B, null, null, null, "keyboard_12key_alphabet_wide_b", "keyboard_12key_alphabet_narrow_b"),
	TWELVE_ALPHABET_SMALLQWERTY	(new Properties(DefaultSoftKeyboard.LANG_EN, false, false, false, false, true, true),
	...
	ENGLISH_DVORAK	(new Properties(DefaultSoftKeyboard.LANG_EN, false, false, false, false, false, false),
	...
	public static class Properties {
		...
		public Properties(boolean altMode, boolean direct, boolean predictive, boolean fullMoachigi, boolean twelveEngine, boolean timeout) {
			this(DefaultSoftKeyboard.LANG_KO, altMode, direct, predictive, fullMoachigi, twelveEngine, timeout);
		}
