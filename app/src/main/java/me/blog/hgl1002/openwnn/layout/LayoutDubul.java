...
public class LayoutDubul {
	...
	public static final int[][] COMB_DUBUL_DUGYEOBE = {
			{0x011169, 0x1161, 0x116a},
			{0x011169, 0x1162, 0x116b},
			{0x011169, 0x1175, 0x116c},
			{0x01116e, 0x1165, 0x116f},
			{0x01116e, 0x1166, 0x1170},
			{0x01116e, 0x1175, 0x1171},
			{0x011173, 0x1175, 0x1174},
