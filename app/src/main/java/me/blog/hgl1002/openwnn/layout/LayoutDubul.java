...
public class LayoutDubul {
	...
	public static final int[][] JAMO_DUBUL_DUGYEOBE_CHOJUNG = {
			{49,0x31,0x21},
			{50,0x32,0x40},
			{51,0x33,0x23},
			{52,0x34,0x24},
			...
			{118, 0x314d, 0x314d},		// v
			{98, 0x3160, 0x3160},			// b
			{110, 0x01315c, 0x01315c},		// n
			{109, 0x013161, 0x013161},		// m
	};

	public static final int[][] JAMO_DUBUL_DUGYEOBE_CHOJONG = {
			{49,0x31,0x21},
			{50,0x32,0x40},
			{51,0x33,0x23},
			{52,0x34,0x24},
	...
	public static final int[][][] JAMOSET_DUBUL_DUGYEOBE = {
			JAMO_DUBUL_DUGYEOBE_CHOJUNG,
			JAMO_DUBUL_DUGYEOBE_CHOJUNG,
			JAMO_DUBUL_DUGYEOBE_CHOJONG,
			JAMO_DUBUL_DUGYEOBE_CHOJONG
	};

	public static final int[][] JAMO_DUBUL_DUJULE = {
			{49,0x31,0x21},
			{50,0x32,0x40},
			{51,0x33,0x23},
			{52,0x34,0x24},
	...
	public static final int[][] COMB_DUBUL_EXPANSION = {
			{0x011169, 0x1161, 0x116a},		// ㅘ
			{0x1161, 0x011169, 0x116a},		// ㅘ
			{0x011169, 0x1162, 0x116b}, 	// ㅙ
			{0x1162, 0x011169, 0x116b}, 	// ㅙ
			{0x011169, 0x1175, 0x116c}, 	// ㅚ
			{0x1175, 0x011169, 0x116c}, 	// ㅚ
			{0x01116e, 0x1165, 0x116f}, 	// ㅝ
			{0x1165, 0x01116e, 0x116f}, 	// ㅝ
			{0x01116e, 0x1166, 0x1170}, 	// ㅞ
			{0x1166, 0x01116e, 0x1170}, 	// ㅞ
			{0x01116e, 0x1175, 0x1171}, 	// ㅟ
			{0x1175, 0x01116e, 0x1171}, 	// ㅟ
			{0x011173, 0x1175, 0x1174}, 	// ㅢ
			{0x1175, 0x011173, 0x1174}, 	// ㅢ

			{0x1169, 0x1161, 0x116a},		// ㅘ
			{0x1161, 0x1169, 0x116a},		// ㅘ
			{0x1169, 0x1162, 0x116b}, 		// ㅙ
			{0x1162, 0x1169, 0x116b}, 		// ㅙ
			{0x1169, 0x1175, 0x116c}, 		// ㅚ
			{0x1175, 0x1169, 0x116c}, 		// ㅚ
			{0x116e, 0x1165, 0x116f}, 		// ㅝ
			{0x1165, 0x116e, 0x116f}, 		// ㅝ
			{0x116e, 0x1166, 0x1170}, 		// ㅞ
			{0x1166, 0x116e, 0x1170}, 		// ㅞ
			{0x116e, 0x1175, 0x1171}, 		// ㅟ
			{0x1175, 0x116e, 0x1171}, 		// ㅟ
			{0x1173, 0x1175, 0x1174}, 		// ㅢ
			{0x1175, 0x1173, 0x1174}, 		// ㅢ

			{0x11a8, 0x11ba, 0x11aa},		// ㄳ
			{0x11ba, 0x11a8, 0x11aa},		// ㄳ
			{0x11ab, 0x11bd, 0x11ac},		// ㄵ
			{0x11bd, 0x11ab, 0x11ac},		// ㄵ
			{0x11ab, 0x11c2, 0x11ad},		// ㄶ
			{0x11c2, 0x11ab, 0x11ad},		// ㄶ
			{0x11af, 0x11a8, 0x11b0},		// ㄺ
			{0x11a8, 0x11af, 0x11b0},		// ㄺ
			{0x11af, 0x11b7, 0x11b1},		// ㄻ
			{0x11b7, 0x11af, 0x11b1},		// ㄻ
			{0x11af, 0x11b8, 0x11b2},		// ㄼ
			{0x11b8, 0x11af, 0x11b2},		// ㄼ
			{0x11af, 0x11ba, 0x11b3},		// ㄽ
			{0x11ba, 0x11af, 0x11b3},		// ㄽ
			{0x11af, 0x11c0, 0x11b4},		// ㄾ
			{0x11c0, 0x11af, 0x11b4},		// ㄾ
			{0x11af, 0x11c1, 0x11b5},		// ㄿ
			{0x11c1, 0x11af, 0x11b5},		// ㄿ
			{0x11af, 0x11c2, 0x11b6},		// ㅀ
			{0x11c2, 0x11af, 0x11b6},		// ㅀ
			{0x11b8, 0x11ba, 0x11b9},		// ㅄ
			{0x11ba, 0x11b8, 0x11b9},		// ㅄ
	};
